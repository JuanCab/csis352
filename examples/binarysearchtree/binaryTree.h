...
// Author: D.S. Malik
// Description: This is a header file for a binary tree. It is a template base
// abstract class that defines a binary tree. The implementation is also in this
// file.
...
// FINISH THE FOLLOWING TWO FUNCTIONS, BE SURE TO INCLUDE COMMENTS
// THAT DESCRIBE YOUR APPROACH TO THE ALGORITHM
// The remaining functions were written by: <YOUR NAME HERE>
