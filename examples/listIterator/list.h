...
{
    // We need to declare the listIterator class before the List class,
    // because the List class uses the listIterator class.  We will further
    // define the listIterator class after the List class.
    template <class T>
    class listIterator;
